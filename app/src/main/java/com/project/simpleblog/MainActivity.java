...
import static com.project.simpleblog.R.id.post_title;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Blog,BlogViewHolder> firebseRecyclerAdapter=new FirebaseRecyclerAdapter<Blog,BlogViewHolder>(
                Blog.class,
                R.layout.blog_row,
        ...
        mBlogList.setAdapter(firebseRecyclerAdapter);
     ...
     public static class BlogViewHolder extends RecyclerView.ViewHolder
     {
         ...
         public void setLikeBtn(final String post_key){
             ...
             mDatabaseLike.addValueEventListener(new ValueEventListener() {
                 ...
                 public void onDataChange(DataSnapshot dataSnapshot) {
                     if(dataSnapshot.child(post_key).hasChild(mAuth.getCurrentUser().getUid())) {
                         mLikebtn.setImageResource(R.mipmap.hearts);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(item.getItemId()==R.id.profile){
            Intent p=new Intent(MainActivity.this,MyProfile.class);
            startActivity(p);
